...
contract('Subgraph', (accounts) => {
  it('init', async () => {
    ...
    // deploy tokens
    MT001 = await NRC6.new("USDT", "USDT", 18, web3.utils.toWei("10000", 'ether'), accounts[0], {from: accounts[0]});
    MT002 = await NRC6.new("MT3", "MT3", 18, web3.utils.toWei("10000", 'ether'), accounts[0], {from: accounts[0]});
  ...
  it('addLiquidity for ETHAndMT001Pair', async () => {
    const tokenAmount = web3.utils.toWei("756", 'ether');
    const ethAmount = web3.utils.toWei("10000", 'ether');
  ...
  //   var pairFor = await testRouter.pairFor(uniswapV2Factory.address, MT002.address, wETH.address);
  ...
  //   const swapETHAmount = web3.utils.toWei("1000", 'ether');
  ...
  //   const swapMT001Amount = web3.utils.toWei("1000", 'ether');
